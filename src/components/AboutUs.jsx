...
import aboutLogo from "/praviras-logo2.png";
          ...
          <div className="about__us__mobile__img">
            <Fade left>
              <img
                ...
                className="about__us__mobile__img1"
              />
            </Fade>
            <Fade right>
              <img
                ...
                alt=""
                style={{ borderRadius: "10px" }}
                className="about__us__mobile__img2"
              />
            </Fade>
          </div>
          <Fade up>
            <div>
              <p className="about__us__content__mobile">
                ...
                me and says Amma, I want to be like you. What a happy day for a
                mother but the next few words shook me hard. She added that she
                wanted to do all the house chores & stay at home. <br />
                <br /> Just like me. Not wrong at all, BUT being my daughter's
                hope I wanted her to see my entrepreneur skills too. That's how
                my venture was born. A world filled with handcrafted
                jewellery's. That's done with same love and care that a mother
                shows to her child. Converting my passion into profession is the
                first step towards our journey. Pravira's is home of jewellery's
                our design, your designs anything u say can be done. So do visit
                us. And support a mother's passion 😊
              </p>
            </div>
          </Fade>
        </div>
